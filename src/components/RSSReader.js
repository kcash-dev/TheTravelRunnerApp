                ...
                >
                    <View style={ tailwind(`flex-1 bg-black bg-opacity-40 items-center w-full`) }>
                        <View style={ tailwind(`flex-row justify-evenly items-center`) }>
                            <Animated.Image 
                                style={[ tailwind(`mt-12 h-14 w-14 rounded-lg`), { opacity: headerTitleOpacity} ]}
                        ...
                        <Animated.Text style={[ tailwind(`absolute bottom-16 mb-2 text-4xl font-bold text-white text-opacity-90 italic`), { opacity: heroTitleOpacity} ]}>The Travel Runner</Animated.Text>
                        <Animated.Text style={[ tailwind(`absolute bottom-14 px-2 text-center text-white text-opacity-90`), { opacity: heroTitleOpacity} ]}>Where Travel and Trail Running Collide</Animated.Text>
                        <Animated.Image 
                            style={[ tailwind(`absolute rounded-lg top-10 left-2 h-20 w-20`), { opacity: heroTitleOpacity} ]}
                            source={{ uri: 'https://i.imgur.com/smHitpL.png' }}
                        />
                    </View>
                </ImageBackground>
